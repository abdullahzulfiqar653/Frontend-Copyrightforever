...
function FormFive() {
	...
	const submitData = async () => {
		...
		data.append('authorship_pseudonymous', serialWorkData.authorship_pseudonymous)
		...
		data.append('how_obtained_ownership', serialWorkData.how_obtained_ownership)
		// Section_5
		data.append('previously_registered', serialWorkData.previously_registered)
		data.append('first_published_edition_of_work', serialWorkData.first_published_edition_of_work)
		data.append('first_application_by_the_author', serialWorkData.first_application_by_the_author)
		data.append('changed_version_of_the_work', serialWorkData.changed_version_of_the_work)
		data.append('prior_reg_number', serialWorkData.prior_reg_number)
		data.append('prior_reg_year', serialWorkData.prior_reg_year)
		// Section_6
		data.append('identify_preexisting_work', serialWorkData.identify_preexisting_work)
		data.append('describe_preexisting_work', serialWorkData.describe_preexisting_work)
		// Section_7
		data.append('file', serialWorkData.file)
		// Section_8
		data.append('employer_name', serialWorkData.employer_name)
		data.append('employer_date_of_birth', serialWorkData.employer_date_of_birth)
		data.append('date_of_hiring', serialWorkData.date_of_hiring)
		data.append('employer_address', serialWorkData.employer_address)
		data.append('date_of_employing_copyright', serialWorkData.date_of_employing_copyright)
		...
		data.append('authorship_anonymous_1', serialWorkData.authorship_anonymous_1)
		data.append('authorship_pseudonymous_1', serialWorkData.authorship_pseudonymous_1)
		data.append('nature_of_authorship_1', serialWorkData.nature_of_authorship_1)
		// continuation_section_2
		...
		data.append('authorship_anonymous_2', serialWorkData.authorship_anonymous_2)
		data.append('authorship_pseudonymous_2', serialWorkData.authorship_pseudonymous_2)
		data.append('nature_of_authorship_2', serialWorkData.nature_of_authorship_2)
		// continuation_section_3
		...
		data.append('authorship_anonymous_3', serialWorkData.authorship_anonymous_3)
		data.append('authorship_pseudonymous_3', serialWorkData.authorship_pseudonymous_3)
		data.append('nature_of_authorship_3', serialWorkData.nature_of_authorship_3)
		// continuation_form_last_fields_after_Authors
	...
	return (
		<multiStepContext.Provider value={{ serialWorkData, setSerialWorkData, submitData, error, loading }}>
