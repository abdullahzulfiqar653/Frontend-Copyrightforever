		...
		<div>
			...
			<div>
				<div component='fieldset' className='mt-4 fieldset'>
					...
					<RadioGroup
						...
						onChange={(e) =>
							setSerialWorkData({ ...serialWorkData, previously_registered: e.target.value })
						}
					>
			...
			<div className='d-flex input_contained'>
				<TextField
					...
					onChange={(e) =>
						setSerialWorkData({ ...serialWorkData, prior_reg_number: e.target.value })
					}
				/>
				<TextField
					label='Year'
					...
					onChange={(e) =>
						setSerialWorkData({ ...serialWorkData, prior_reg_year: e.target.value })
					}
				/>
			</div>
