    ...
    <div>
      ...
      <div>
        <TextField
          ...
          helperText={`${serialWorkData.year_of_authorship.length}/${CHARACTER_LIMIT}`}
      ...
      <div className="d-flex input_contained">
        ...
        <TextField
          ...
          color="secondary"
          className="mr-3"
          value={serialWorkData["year"]}
          onInput={(e) => {
            e.target.value = Math.max(0, parseInt(e.target.value))
              .toString()
              .slice(0, CHARACTER_LIMIT);
          }}
          helperText={`${serialWorkData.year.length}/${CHARACTER_LIMIT}`}
          name="year"
          onChange={(e) =>
            setSerialWorkData({
              ...serialWorkData,
