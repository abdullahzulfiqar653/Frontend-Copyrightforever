...
function FormThree() {
  ...
  const [virtualArtData, setVirtualArtData] = useState({
    ...
    dimensional_sculpture: false,
    dimensional_artwork: false,
    reproduction_of_artwork: false,
    map: false,
    photograph: false,
    jewelery_design: false,
  ...
  const submitData = async () => {
    ...
    data.append("dimensional_sculpture", virtualArtData.dimensional_sculpture);
    data.append("dimensional_artwork", virtualArtData.dimensional_artwork);
    data.append(
      "reproduction_of_artwork",
      virtualArtData.reproduction_of_artwork
    );
    data.append("map", virtualArtData.map);
    data.append("photograph", virtualArtData.photograph);
    data.append("jewelery_design", virtualArtData.jewelery_design);
    data.append("technical_drawing", virtualArtData.technical_drawing);
    data.append("text", virtualArtData.text);
    // Section_3
    data.append("year_of_authorship", virtualArtData.year_of_authorship);
    data.append("day", virtualArtData.day);
    data.append("month", virtualArtData.month);
    data.append("year", virtualArtData.year);
