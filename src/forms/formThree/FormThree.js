...
function FormThree() {
	...
	const submitData = async () => {
		setLoading(true)
		console.log(virtualArtData, user)
		...
		data.append('title_of_collective_work', virtualArtData.title_of_collective_work)
		...
		data.append('authorship_pseudonymous', virtualArtData.authorship_pseudonymous)
		...
		data.append('how_obtained_ownership', virtualArtData.how_obtained_ownership)
		// Section_5
		data.append('previously_registered', virtualArtData.previously_registered)
		data.append('first_published_edition_of_work', virtualArtData.first_published_edition_of_work)
		data.append('first_application_by_the_author', virtualArtData.first_application_by_the_author)
		data.append('changed_version_of_the_work', virtualArtData.changed_version_of_the_work)
		data.append('prior_reg_number', virtualArtData.prior_reg_number)
		data.append('prior_reg_year', virtualArtData.prior_reg_year)
		// Section_6
		data.append('identify_preexisting_work', virtualArtData.identify_preexisting_work)
		data.append('describe_preexisting_work', virtualArtData.describe_preexisting_work)
		// Section_7
		data.append('file', virtualArtData.file)
		// Section_8
		data.append('employer_name', virtualArtData.employer_name)
		data.append('employer_date_of_birth', virtualArtData.employer_date_of_birth)
		data.append('date_of_hiring', virtualArtData.date_of_hiring)
		data.append('employer_address', virtualArtData.employer_address)
		data.append('date_of_employing_copyright', virtualArtData.date_of_employing_copyright)
		...
		data.append('authorship_anonymous_1', virtualArtData.authorship_anonymous_1)
		data.append('authorship_pseudonymous_1', virtualArtData.authorship_pseudonymous_1)
		data.append('nature_of_authorship_1', virtualArtData.nature_of_authorship_1)
		// continuation_section_2
		...
		data.append('authorship_anonymous_2', virtualArtData.authorship_anonymous_2)
		data.append('authorship_pseudonymous_2', virtualArtData.authorship_pseudonymous_2)
		data.append('nature_of_authorship_2', virtualArtData.nature_of_authorship_2)
		// continuation_section_3
		...
		data.append('authorship_anonymous_3', virtualArtData.authorship_anonymous_3)
		data.append('authorship_pseudonymous_3', virtualArtData.authorship_pseudonymous_3)
		data.append('nature_of_authorship_3', virtualArtData.nature_of_authorship_3)
		// continuation_form_last_fields_after_Authors
	...
	return (
		<multiStepContext.Provider value={{ virtualArtData, setVirtualArtData, submitData, error, loading }}>
