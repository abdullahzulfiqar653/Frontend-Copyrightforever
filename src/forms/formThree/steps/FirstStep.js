  ...
  return (
    <div>
      ...
      <TextField
        ...
        onChange={(e) =>
          setVirtualArtData({ ...virtualArtData, prior_title: e.target.value })
        }
      />
      ...
      <FormLabel
        ...
        component="legend"
      >
        If your work was previously published in any periodical, serial, or
        collection, give information about the collective work in which the
        contribution appeared? If so, please provide:
      </FormLabel>
      <TextField
        ...
        onChange={(e) =>
          setVirtualArtData({
            ...virtualArtData,
            title_of_collective_work: e.target.value,
          })
        }
      />
      <div className="d-flex input_contained">
        <TextField
          ...
          onChange={(e) =>
            setVirtualArtData({ ...virtualArtData, volume: e.target.value })
          }
        />
        <TextField
          className="mr-3"
          ...
          onChange={(e) =>
            setVirtualArtData({ ...virtualArtData, number: e.target.value })
          }
        />
        <TextField
          id="date"
          ...
          onChange={(e) =>
            setVirtualArtData({ ...virtualArtData, issue_date: e.target.value })
          }
        />
        <TextField
          label=" Pages"
          ...
          onChange={(e) =>
            setVirtualArtData({ ...virtualArtData, pages: e.target.value })
          }
        />
      </div>
      <div>
