		...
		<div>
			...
			<div>
				<div component='fieldset' className='mt-4 fieldset'>
					...
					<RadioGroup
						...
						onChange={(e) =>
							setSoundRecordingData({ ...soundRecordingData, previously_registered: e.target.value })
						}
					>
			...
			<div className='d-flex input_contained'>
				<TextField
					...
					onChange={(e) =>
						setSoundRecordingData({ ...soundRecordingData, prior_reg_number: e.target.value })
					}
				/>
				<TextField
					label='Year'
					...
					onChange={(e) =>
						setSoundRecordingData({ ...soundRecordingData, prior_reg_year: e.target.value })
					}
				/>
			</div>
