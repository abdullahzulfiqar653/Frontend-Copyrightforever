    ...
    <div>
      ...
      <div>
        <TextField
          ...
          helperText={`${soundRecordingData.year_of_authorship.length}/${CHARACTER_LIMIT}`}
          margin="normal"
          variant="outlined"
          color="secondary"
      ...
      <div className="d-flex input_contained">
        <FormControl className="mr-3" variant="outlined" margin="normal">
          ...
          <Select
            ...
            label="Age"
            value={soundRecordingData["month"]}
            name="month"
            onChange={(e) =>
              setSoundRecordingData({
                ...soundRecordingData,
        ...
        <TextField
          ...
          color="secondary"
          className="mr-3"
          value={soundRecordingData["year"]}
          onInput={(e) => {
            e.target.value = Math.max(0, parseInt(e.target.value))
              .toString()
              .slice(0, CHARACTER_LIMIT);
          }}
          helperText={`${soundRecordingData.year.length}/${CHARACTER_LIMIT}`}
          name="year"
          onChange={(e) =>
            setSoundRecordingData({
              ...soundRecordingData,
