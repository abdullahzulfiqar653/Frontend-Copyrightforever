...
function FormFour() {
  ...
  const submitData = async () => {
    ...
    data.append(
      "authorship_anonymous",
      soundRecordingData.authorship_anonymous
    );
    data.append(
      "authorship_pseudonymous",
      soundRecordingData.authorship_pseudonymous
    );
    data.append(
      "nature_of_authorship",
      soundRecordingData.nature_of_authorship
    );
    // Section_3
    ...
    data.append(
      "how_obtained_ownership",
      soundRecordingData.how_obtained_ownership
    );
    // Section_5
    data.append(
      "previously_registered",
      soundRecordingData.previously_registered
    );
    data.append(
      "first_published_edition_of_work",
      soundRecordingData.first_published_edition_of_work
    );
    data.append(
      "first_application_by_the_author",
      soundRecordingData.first_application_by_the_author
    );
    data.append(
      "changed_version_of_the_work",
      soundRecordingData.changed_version_of_the_work
    );
    ...
    data.append(
      "identify_preexisting_work",
      soundRecordingData.identify_preexisting_work
    );
    data.append(
      "describe_preexisting_work",
      soundRecordingData.describe_preexisting_work
    );
    // Section_7
    ...
    data.append(
      "employer_date_of_birth",
      soundRecordingData.employer_date_of_birth
    );
    ...
    data.append(
      "authorship_anonymous_1",
      soundRecordingData.authorship_anonymous_1
    );
    data.append(
      "authorship_pseudonymous_1",
      soundRecordingData.authorship_pseudonymous_1
    );
    data.append(
      "nature_of_authorship_1",
      soundRecordingData.nature_of_authorship_1
    );
    // continuation_section_2
    ...
    data.append(
      "authorship_anonymous_2",
      soundRecordingData.authorship_anonymous_2
    );
    data.append(
      "authorship_pseudonymous_2",
      soundRecordingData.authorship_pseudonymous_2
    );
    data.append(
      "nature_of_authorship_2",
      soundRecordingData.nature_of_authorship_2
    );
    // continuation_section_3
    ...
    data.append(
      "authorship_anonymous_3",
      soundRecordingData.authorship_anonymous_3
    );
    data.append(
      "authorship_pseudonymous_3",
      soundRecordingData.authorship_pseudonymous_3
    );
    data.append(
      "nature_of_authorship_3",
      soundRecordingData.nature_of_authorship_3
    );
    // continuation_form_last_fields_after_Authors
    ...
    data.append(
      "continuation_address",
      soundRecordingData.continuation_address
    );
    ...
    data.append(
      "continuation_zipcode",
      soundRecordingData.continuation_zipcode
    );
