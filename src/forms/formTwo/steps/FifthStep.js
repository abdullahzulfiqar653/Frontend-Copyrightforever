		...
		<div>
			...
			<div>
				<div component='fieldset' className='mt-4 fieldset'>
					...
					<RadioGroup
						...
						onChange={(e) =>
							setLiteraryWorksData({ ...literaryWorksData, previously_registered: e.target.value })
						}
					>
			...
			<div className='d-flex input_contained'>
				<TextField
					...
					onChange={(e) =>
						setLiteraryWorksData({ ...literaryWorksData, prior_reg_number: e.target.value })
					}
				/>
				<TextField
					label='Year'
					...
					onChange={(e) =>
						setLiteraryWorksData({ ...literaryWorksData, prior_reg_year: e.target.value })
					}
				/>
			</div>
