    ...
    <div>
      ...
      <div>
        <TextField
          ...
          variant="outlined"
          color="secondary"
          value={literaryWorksData["year_of_authorship"]}
          onInput={(e) => {
            e.target.value = Math.max(0, parseInt(e.target.value))
              .toString()
              .slice(0, CHARACTER_LIMIT);
          }}
          helperText={`${literaryWorksData.year_of_authorship.length}/${CHARACTER_LIMIT}`}
          onChange={(e) =>
      ...
      <div className="d-flex input_contained">
        ...
        <TextField
          ...
          color="secondary"
          className="mr-3"
          value={literaryWorksData["year"]}
          onInput={(e) => {
            e.target.value = Math.max(0, parseInt(e.target.value))
              .toString()
              .slice(0, CHARACTER_LIMIT);
          }}
          helperText={`${literaryWorksData.year.length}/${CHARACTER_LIMIT}`}
          onChange={(e) =>
            setLiteraryWorksData({
              ...literaryWorksData,
              year: e.target.value,
        ...
        <TextField
          ...
          variant="outlined"
          color="secondary"
          value={literaryWorksData["nation"]}
          onChange={(e) =>
            setLiteraryWorksData({
              ...literaryWorksData,
