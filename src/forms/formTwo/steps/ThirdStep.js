		...
		<div>
			...
			<div>
				<TextField
					...
					onChange={(e) =>
						setLiteraryWorksData({ ...literaryWorksData, year_of_authorship: e.target.value })
					}
				/>
			</div>
			...
			<div className='d-flex input_contained'>
				...
				<TextField
					...
					onChange={(e) =>
						setLiteraryWorksData({ ...literaryWorksData, nation: e.target.value })
					}
				/>
			</div>
			...
			<Button onClick={() => {
				...
				setLiteraryWorksData({ ...literaryWorksData, date_of_authorship: String(a) })
				setStep(4)
