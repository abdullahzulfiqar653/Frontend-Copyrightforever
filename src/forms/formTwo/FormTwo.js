...
function FormTwo() {
	...
	const submitData = async () => {
		...
		data.append('title_of_collective_work', literaryWorksData.title_of_collective_work)
		...
		data.append('authorship_pseudonymous', literaryWorksData.authorship_pseudonymous)
		...
		data.append('how_obtained_ownership', literaryWorksData.how_obtained_ownership)
		// Section_5
		data.append('previously_registered', literaryWorksData.previously_registered)
		data.append('first_published_edition_of_work', literaryWorksData.first_published_edition_of_work)
		data.append('first_application_by_the_author', literaryWorksData.first_application_by_the_author)
		data.append('changed_version_of_the_work', literaryWorksData.changed_version_of_the_work)
		...
		// Section_6
		data.append('identify_preexisting_work', literaryWorksData.identify_preexisting_work)
		data.append('describe_preexisting_work', literaryWorksData.describe_preexisting_work)
		// Section_7
		data.append('file', literaryWorksData.file)
		// Section_8
		data.append('employer_name', literaryWorksData.employer_name)
		data.append('employer_date_of_birth', literaryWorksData.employer_date_of_birth)
		...
		data.append('date_of_employing_copyright', literaryWorksData.date_of_employing_copyright)
		...
		data.append('authorship_anonymous_1', literaryWorksData.authorship_anonymous_1)
		data.append('authorship_pseudonymous_1', literaryWorksData.authorship_pseudonymous_1)
		data.append('nature_of_authorship_1', literaryWorksData.nature_of_authorship_1)
		// continuation_section_2
		...
		data.append('authorship_anonymous_2', literaryWorksData.authorship_anonymous_2)
		data.append('authorship_pseudonymous_2', literaryWorksData.authorship_pseudonymous_2)
		data.append('nature_of_authorship_2', literaryWorksData.nature_of_authorship_2)
		// continuation_section_3
		...
		data.append('authorship_anonymous_3', literaryWorksData.authorship_anonymous_3)
		data.append('authorship_pseudonymous_3', literaryWorksData.authorship_pseudonymous_3)
		data.append('nature_of_authorship_3', literaryWorksData.nature_of_authorship_3)
		// continuation_form_last_fields_after_Authors
	...
	return (
		<multiStepContext.Provider value={{ literaryWorksData, setLiteraryWorksData, submitData, error, loading }}>
						...
						textField={
							<div className='d-flex input_contained'>
								<TextField
									...
									onChange={(e) =>
										setLiteraryWorksData({ ...literaryWorksData, mailing_address: e.target.value })
									}
								/>
								<TextField
									label='City:'
								...
								<FormControl className='mr-3' variant='outlined' margin='normal'>
									...
									<Select
										...
										onChange={(e) =>
											setLiteraryWorksData({ ...literaryWorksData, state: e.target.value })
										}
									>
								...
								<TextField
									...
									onChange={(e) =>
										setLiteraryWorksData({ ...literaryWorksData, zipcode: e.target.value })
									}
								/>
							</div>
						}
