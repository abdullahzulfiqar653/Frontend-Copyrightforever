		...
		<div>
			...
			<div>
				<div component='fieldset' className='mt-4 fieldset'>
					...
					<RadioGroup
						...
						name='radio'
						className='flex-row'
						value={performingArtData['previously_registered']}
						onChange={(e) =>
							setPerformingArtData({ ...performingArtData, previously_registered: e.target.value })
						}
					>
			...
			<div className='d-flex input_contained'>
				<TextField
					...
					color='secondary'
					className='mr-3'
					value={performingArtData['prior_reg_number']}
					onChange={(e) =>
						setPerformingArtData({ ...performingArtData, prior_reg_number: e.target.value })
					}
				/>
				<TextField
					label='Year'
					...
					variant='outlined'
					color='secondary'
					value={performingArtData['prior_reg_year']}
					onChange={(e) =>
						setPerformingArtData({ ...performingArtData, prior_reg_year: e.target.value })
					}
				/>
			</div>
