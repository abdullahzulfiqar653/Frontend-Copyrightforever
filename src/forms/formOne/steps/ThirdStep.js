		...
		<div>
			...
			<div>
				<TextField
					...
					onChange={(e) =>
						setPerformingArtData({ ...performingArtData, year_of_authorship: e.target.value })
					}
				/>
			</div>
			...
			<div className='d-flex input_contained'>
				...
				<TextField
					...
					onChange={(e) =>
						setPerformingArtData({ ...performingArtData, nation: e.target.value })
					}
				/>
			</div>
			...
			<Button onClick={() => {
				...
				setPerformingArtData({ ...performingArtData, date_of_authorship: String(a) })
				setStep(4)
