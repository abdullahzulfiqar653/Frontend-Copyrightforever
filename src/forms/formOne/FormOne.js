...
function FormOne() {
	...
	const submitData = async () => {
		...
		data.append('authorship_pseudonymous', performingArtData.authorship_pseudonymous)
		...
		data.append('how_obtained_ownership', performingArtData.how_obtained_ownership)
		// Section_5
		data.append('previously_registered', performingArtData.previously_registered)
		data.append('first_published_edition_of_work', performingArtData.first_published_edition_of_work)
		data.append('first_application_by_the_author', performingArtData.first_application_by_the_author)
		data.append('changed_version_of_the_work', performingArtData.changed_version_of_the_work)
		...
		// Section_6
		data.append('identify_preexisting_work', performingArtData.identify_preexisting_work)
		data.append('describe_preexisting_work', performingArtData.describe_preexisting_work)
		// Section_7
		data.append('file', performingArtData.file)
		// Section_8
		data.append('employer_name', performingArtData.employer_name)
		data.append('employer_date_of_birth', performingArtData.employer_date_of_birth)
		...
		data.append('date_of_employing_copyright', performingArtData.date_of_employing_copyright)
		...
		data.append('authorship_anonymous_1', performingArtData.authorship_anonymous_1)
		data.append('authorship_pseudonymous_1', performingArtData.authorship_pseudonymous_1)
		data.append('nature_of_authorship_1', performingArtData.nature_of_authorship_1)
		// continuation_section_2
		...
		data.append('authorship_anonymous_2', performingArtData.authorship_anonymous_2)
		data.append('authorship_pseudonymous_2', performingArtData.authorship_pseudonymous_2)
		data.append('nature_of_authorship_2', performingArtData.nature_of_authorship_2)
		// continuation_section_3
		...
		data.append('authorship_anonymous_3', performingArtData.authorship_anonymous_3)
		data.append('authorship_pseudonymous_3', performingArtData.authorship_pseudonymous_3)
		data.append('nature_of_authorship_3', performingArtData.nature_of_authorship_3)
		// continuation_form_last_fields_after_Authors
		...
		try {
        	...
        	REQUEST_URL + `/api/paform/add`,
        	data,
        	config
			);
			setLoading(false)
			setTimeout(function(){ alert("Form "+ res.statusText + ". Now pay for further proceeding or you also can pay later from YourAccount by selecting the given form"); }, 1000);
		} catch (error) {
			setLoading(false)
	...
	return (
		<multiStepContext.Provider value={{ performingArtData, setPerformingArtData, submitData, error, loading }}>
